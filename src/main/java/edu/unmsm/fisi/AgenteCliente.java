...
public class AgenteCliente extends Agent {
    protected void setup() {
        ...
        buscarServicioRestaurante(cliente_servicio);
    ...
    protected void buscarServicioRestaurante(ServiceDescription sd){
            ...
            protected void onTick() {
                ...
                try {
                    ...
                    if (res.length != 0){
                        ...
                        msg.setContent("Solicito un pedido");
                        myAgent.send(msg);
                        stop();
                    } else {
    ...
    protected void takeDown(){
        System.out.printf("[Cliente: %s] - Cliente se despide", getLocalName());
    }
}
